...
def rnn_cell(module_name, hidden_dim):
  ...
  if (module_name == 'gru'):
    ...
    rnn_cell = tf.keras.layers.GRU(units=hidden_dim, activation='tanh')
  # LSTM
  ...
  #   rnn_cell = tf.contrib.rnn.LayerNormBasicLSTMCell(num_units=hidden_dim, activation=tf.nn.tanh)
    rnn_cell = keras.Sequential([
      keras.layers.LSTM(units=hidden_dim,activation='tanh',return_sequences=True),
